...
const inviteToRole = {
  RPDeG566gf: "0 a Trader",
  //https://discord.gg/RPDeG566gf   Bienvenidos
  drkfqn69C8: "Profesional",
 //https://discord.gg/drkfqn69C8 Profesional
...
client.once("ready", async () => {
  ...
  const invites = await client.guilds.cache
    .get("1229799970396442624") // ID del servidor
    .invites.fetch();
